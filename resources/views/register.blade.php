...
<head>
    ...
    <link rel="icon" href="img/colored-logo.png">
...
<body>
    <div class="logo container"><a href="home.html"><img class="logo" src="img/colored-logo.png" alt=""></a></div>
    <section class="container content">
        <form class="login" action="" method="get">
            <div class="form">
                <h1>Register to Go Win Sports Academy</h1>
                <div class="name">
    ...
    <footer>
        <div class="container">
            <div class="column column-one">
                <img class="logo" src="img/colored-logo.png" alt="">
            ...
            <div class="column column-two">
                ...
                <a href="aboutus.html"><i class="far fa-address-card"></i> About Us</a>
                <a href="gallery.html"><i class="fas fa-photo-video"></i> Gallery</a>
